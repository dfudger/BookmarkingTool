...
The current version of the tool, includes the basic functionality to complete the primary use cases. Please see future features for more information on upcoming additions.
...
These are the features that will be added in upcoming iterations of the project. 
